...
from health_mldl.config import ML_FIGURES_DIR, ML_ARTIFACTS_DIR, RAW_DATA_DIR, ML_REPORTS_DIR
...
def main() -> None:
    ...
    save_correlation_heatmap(feat_df, ML_FIGURES_DIR / "correlation_heatmap.png")
    ...
    save_joblib(baseline, ML_ARTIFACTS_DIR / "baseline_random_forest.joblib")
    save_json(metrics, ML_REPORTS_DIR / "baseline_metrics.json")
